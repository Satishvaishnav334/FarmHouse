    ...
    <>
      <div className="bg-white text-gray-800">
        <nav className="lg:h-[4.5rem] h-16 lg:py-5 pt-4 pb-[1rem] flex justify-between items-center space-x-2 px-5 lg:px-20 border-b-[1px] border-zinc-700 select-none">
          <Link
            to="/"
            className="text-gray-700  dark:text-zinc-300 dark:hover:text-white transition-colors cursor-pointer text-2xl font-helvetica font-semibold flex space-x-2 justify-center items-center"
          >
            <img
              src="/logo.png"
              alt="app-logo"
              width="30px"
              className="h-[30px] active:animate-spin"
            />
